...
int a,b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Toast.makeText(getApplicationContext(),String.valueOf(cnt),Toast.LENGTH_SHORT).show();
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("assesment").child("tiredness");
    ...
    public void loadTest(View view) {
        switch (view.getId()) {
            ...
            case R.id.button2:
                ...
                cnt = cnt + 0;
                Intent intent1 = new Intent(getApplicationContext(), test4.class);
